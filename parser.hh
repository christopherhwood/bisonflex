...
#line 8 "manual.y" // lalr1.cc:417

  #include <string>
  class driver;

#line 53 "parser.hh" // lalr1.cc:417
...
namespace yy {
#line 169 "parser.hh" // lalr1.cc:417
...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YYASSERT (tok == token::END || tok == token::ASSIGN || tok == token::MINUS || tok == token::PLUS || tok == token::STAR || tok == token::SLASH || tok == token::LPAREN || tok == token::RPAREN);
      }
#else
...
#line 1361 "parser.hh" // lalr1.cc:417
